...
<div class="newslist">
    <div class="main">
        ...
        <div class="container">
            ...
            <div class="right">
                <p class="loca"><a href="newslist.jsp">首页</a>» ${nlistType } </p>
                ...
                <div class="cont">
                	<ul>
                		<c:forEach items="${newsList }" var="list" varStatus="status">
	                		<li>
	                			<span class="title"><span>${status.index+1 }</span><a href="admin/news/findOne.do?nid=${list.nid }" target="_blank">${list.ntitle }</a></span>&nbsp;&nbsp;
