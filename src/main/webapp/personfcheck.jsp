...
<div class="personfcheck">
    <div class="main">
        ...
        <div class="container">
            <div class="left">
                <div class="landlord">
                    <div class="img"><img src="${pforumView.uList.uportrait }"/></div>
                    <div class="info"><p class="name">${pforumView.uList.uname }</p><p class="motto"> ${pforumView.uList.umotto }</p></div>
                    <p align="right"><button class="gocomment">我要评论</button><span class="type">${pforumView.fList.ftype }</span>&nbsp;当前评论人数：<span class="reply">${pforumView.cTotal }</span></p>
                    <hr/>
                    <p class="title" align="center">${pforumView.fList.ftitle }</p>
                    <hr/>
                    <div class="content">${pforumView.fList.fcontent }</div>
                 </div>
                <div class="comments">
                     <ul>
                     	<c:forEach items="${pcommentViewList }" var="list">
	                        <li class="per">
	                            <div class="inleft">
                ...
                <div style="clear: both;"></div>
		        <div class="more" onclick="location.href='forum/queryById.do?fid=${pforumView.fList.fid}'"><p>点击查看全部</p></div>
                <div class="edit">
                    <p>发表评论</p>
                    <div class="content">
                        <form >
                        	<input type="hidden" class="forum_id" value="${pforumView.fList.fid }"/>
