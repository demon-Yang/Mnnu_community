                        ...
                        <ul>
                        	<c:forEach items="${pfdpage.list }" var="list">
	                            <li>
	                                ...
	                                <p class="function" align="right"><span>${list.comment.cdate }</span>&nbsp;&nbsp;<a href="forum/queryOne.do?fid=${list.comment.fid }&cid=${list.comment.cid}" target="_blank">查看</a><a>删除</a></p>
	                            </li>
                            </c:forEach>
                        </ul>
                    </div>
